          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-8">
                We're here to help you succeed. Whether you're looking to improve your social media presence, 
                boost your search rankings, or develop a comprehensive digital marketing strategy, our team 
                is ready to provide personalized solutions.
              </p>
            </div>
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4">
                <a 
                  ...
                  className="bg-primary/10 p-3 rounded-lg hover:bg-primary hover:text-white transition-all duration-300"
                >
